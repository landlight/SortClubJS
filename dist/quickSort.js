...
function quickSort(inputArray, sortOrder = "ascending" /* ASC */) {
...
console.log("Quick Sort" /* QUICK_SORT */, quickSort(unsortedArray, "ascending" /* ASC */), "ascending" /* ASC */);
console.log("Quick Sort" /* QUICK_SORT */, quickSort(unsortedArray, "descending" /* DSC */), "descending" /* DSC */);
